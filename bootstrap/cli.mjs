...
const TOOL_DETAILS = {
  ...
  notebridge: "Use JSON-first bounded reads. Wispr is local read-only; never expose note content unless requested. Apple mutations are dry-run by default and need stable IDs plus --apply --yes. Mirrors are one-way, conflict-aware, and never delete Notes.",
