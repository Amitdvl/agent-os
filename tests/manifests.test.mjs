...
test("portable command and goal contracts retain their required workflow sections", async () => {
  const required = {
    ...
    "commands/trashness/SKILL.md": ["## Operating Principle", "## Build Artifact Hygiene", "## Eligible Categories", "## Absolute Exclusions", "## Approval Contract", "## Deletion Workflow", "## Monthly Automation Behavior", "stable, ignored output root", "unrelated worktrees", "protected-names", "permanent deletion", "exact manifest"],
