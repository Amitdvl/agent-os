...
test("portable command and goal contracts retain their required workflow sections", async () => {
  const required = {
    ...
    "commands/ground/SKILL.md": ["## Usage", "## Natural-language activation", "## Operating Principle", "## The V.A.L.U.E. Formula", "## OS Order Contract", "## Source Handling", "## OS Library Record", "## Output Contract", "semantic intent", "Ground these", "study-ready", "each distinct source", "retrieval-first", "one material page", "Area umbrella"],
